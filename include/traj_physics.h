...
constexpr size_t n_partd = 4 * 1024 * 1024; // n_space * n_space * n_space ; // must be 2 to power of n
...
#define dE_dton_ // whether to calculate the displacement current only usefull if Bon_
